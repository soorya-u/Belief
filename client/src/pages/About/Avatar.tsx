  ...
  return (
    <>
      <div className="h-[300px] group">
        ...
        <div className="w-[12rem] h-[12rem] overflow-hidden relative flex justify-center items-center box-border duration-700 -translate-y-[8.5rem] shadow-['0_20px_40px_rgba(0,0,0,0.4)'] group-hover:-translate-y-4">
          <div className="flex justify-center items-center flex-col gap-1">
